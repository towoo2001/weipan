		...
		<form id="withDraw" class="i-form" method="post" action="<?php echo U('User/cash');?>" onSubmit="return false;">
			<ul class="form-box">
				<li class="f-line clearfix">
					...
					<em><?php echo ($totle["balance"]); ?>元</em>
					<input type="hidden" name="counts" value="<?php echo ($totle["balance"]); ?>" id="counts">
				</li>
				<li class="f-line clearfix">
					<label class="f-label">本次提取金额</label>
					<input id="n-money1" class="f-input" type="text" value="" onkeyup="shiji(this)" placeholder="请输入提取金额" name="bpprice">
				</li>
				<li class="f-line clearfix">
					<label class="f-label" style="color:red">提现规则</label>
					<span style="line-height:2em;color:red;line-height:3em">提现200元（含）以下 收取2元手续费  提现200元以上，每一笔收取手续费1%</span>
				</li>
				<li class="f-line clearfix">
					<label class="f-label">实际提现</label><span style="color:red;font-size:2em" id="shiji">98</span>元
					<input id="n-money" class="f-input" value="98" type="hidden" placeholder="请输入提取金额" name="bpprice1">
				</li>
			</ul>
			...
			<div class="f-p-line">
				<input id="deal-pwd" name="pwd" class="f-pwd" type="password" maxlength="6" placeholder="请输入交易密码">
			</div>
...
<div class="footerart">
	<div class="fontart">
		<?php if( '/Home/User/cash' == '/Home/Index/index'): ?><a style="color:#fff" href="/index.php/Home/Index/"><!--img style="width:3em" src="/Public/Home/images/xz/tu_1.png"/--><br/><em style="font-size:1.5em;color:#E1A22C">首页</em></a>
			<?php else: ?>
			<a style="color:#fff" href="/index.php/Home/Index/"><!--img style="width:3em" src="/Public/Home/images/wx/tu_1.png"/--><br/><em style="font-size:1.5em;color:#fff">首页</em></a><?php endif; ?>

	</div>
	<div class="fontart">
		<?php if( '/Home/User/cash' == '/Home/Detailed/dtrading'): ?><a style="color:#fff" href="/index.php/Home/Detailed/dtrading"><!--img style="width:3em" src="/Public/Home/images/xz/tu_2.png"/--><br/><em style="font-size:1.5em;color:#E1A22C">交易明细</em></a>
			<?php else: ?>
			<a style="color:#fff" href="/index.php/Home/Detailed/dtrading"><!--img style="width:3em" src="/Public/Home/images/wx/tu_2.png"/--><br/><em style="font-size:1.5em;color:#fff">交易明细</em></a><?php endif; ?>
	</div>
	<div class="fontart">
		<?php if( '/Home/User/cash' == '/Home/News/news'): ?><a style="color:#fff" href="/index.php/Home/News/news"><!--img style="width:3em" src="/Public/Home/images/xz/tu_3.png"/--><br/><em style="font-size:1.5em;color:#E1A22C">公告</em></a>
			<?php else: ?>
			<a style="color:#fff" href="/index.php/Home/News/news"><!--img style="width:3em" src="/Public/Home/images/wx/tu_3.png"/--><br/><em style="font-size:1.5em;color:#fff">公告</em></a><?php endif; ?>
	</div>
	<div class="fontart">
		<?php if( '/Home/User/cash' == '/Home/User/memberinfo'): ?><a style="color:#fff" href="/index.php/Home/User/memberinfo"><!--img style="width:3em" src="/Public/Home/images/xz/tu_4.png"/--><br/><em style="font-size:1.5em;color:#E1A22C">帐户</em></a>
			<?php else: ?>
			<a style="color:#fff" href="/index.php/Home/User/memberinfo"><!--img style="width:3em" src="/Public/Home/images/wx/tu_4.png"/--><br/><em style="font-size:1.5em;color:#fff">帐户</em></a><?php endif; ?>
	</div>
</div>
			...
			$.ajax({
				...
				success: function (data) {
					...
					if(data==1){
						...
						$(".f-sub").removeAttr("disabled");
						msg('交易密码未设置，请先设置！');
						window.location.href = "/Home/User/edituser";
					}
					else{
						$(".f-sub").removeAttr("disabled");
						msg('操作成功！正在审核中....');
