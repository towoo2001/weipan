...
<div class="main">
    ...
    <div class="personal_recharge">
        ...
        <ul class="personal_recharge_ul">
            <li class="personal_recharge_ul_li">编号</li>
            <li class="personal_recharge_ul_lia">金额</li>
            <li class="personal_recharge_ul_lia">状态</li>
            <li class="personal_recharge_ul_lib">充值时间</li>
        </ul>
        <ul class="personal_recharge_ula" style="padding-bottom: 50px">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="personal_recharge_ula">
                    <li class="personal_recharge_ul_li"><?php echo ($vo["bpid"]); ?></li>
                    <li id="personal_recharge_ul_lic">&yen;<?php echo ($vo["bpprice"]); ?></li>
                    <li id="personal_recharge_ul_lic"><?php echo ($vo["remarks"]); ?></li>
                    <li class="personal_recharge_ul_lib"><?php echo (date('Y-m-d H:i:s',$vo["bptime"])); ?></li>
