...
<div class="container-fluid">
    ...
    <div id="pad-wrapper">
        ...
        <div class="table-products" style="padding-top: 0;">
            ...
            <div class="row-fluid">
                <table class="table table-hover">
                    ...
                    <?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="first">
							...
							<td>
                                <font color="#f00" size="3">￥<?php echo ($vo['fee']*$vo['onumber']); ?><font>
                            </td>
							<!--td>
            ...
            <div>今日已有<font color="#f00" size="4"><?php echo ($orderDay); ?></font>个<a href="<?php echo U('Order/olist');?>">订单</a>达成交易</div>
        </div>
        <!-- end table sample -->
        ...
        <!--div class="table-products section" style="margin-top: 20px;">
            ...
            <div class="row-fluid">
                <table class="table table-hover">
                    ...
                    <tbody>
                    	<?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pl): $mod = ($i % 2 );++$i;?><tr class="first">
                            <td>
                                <input type="checkbox" />
