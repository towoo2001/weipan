	...
	<div id="pad-wrapper" class="new-user">
		...
		<div class="row-fluid form-wrapper">
			...
			<div class="span9 with-sidebar">
				<div class="container">
					<form class="new_user_form" action="<?php echo U('News/tedit');?>" method="post">
						<input name="fid" type="hidden" value="<?php echo ($gt['fid']); ?>"/>
						<div class="span12 field-box" style="border-top: 1px solid #dee3ea;">
							<label>栏目名称:</label>
							<input class="span3" type="text" value="<?php echo ($gt['fclass']); ?>" name="fclass">
						</div>						
