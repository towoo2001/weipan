    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Coupons/cpedit');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
                	<input type="hidden" name="eid" value="<?php echo ($editex['eid']); ?>"/>
					<div class="field-box">
						<label>商品名称：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入优惠卷价格" data-placement="right" name="eprice" value="<?php echo ($editex['eprice']); ?>"/>
					</div>
					<div class="field-box">
                        <label>开始时间:</label>
					...
					<div class="field-box">
						<label>手续费：</label>
						<input class="span1" type="text" data-toggle="tooltip" data-trigger="focus" title="手续费，百分比" data-placement="right" value="<?php echo ($editgood['feeprice']); ?>" name="feeprice"/>
					</div>
					<!--<div class="field-box">
						<label>缩略图:</label>
