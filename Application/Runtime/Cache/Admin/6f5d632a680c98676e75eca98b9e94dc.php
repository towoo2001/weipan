                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span6 with-sidebar">
                        <div class="span9 field-box uname">
							...
							<?php if($userme["ustatus"] == 1): ?><a href="/Admin/User/dongtis?uid=<?php echo ($userme['uid']); ?>&types=2">解冻</a><?php else: ?><a href="/Admin/User/dongtis?uid=<?php echo ($userme['uid']); ?>&types=1">冻结</a><?php endif; ?>
                        </div>
                        ...
                        <div class="span9 field-box">
                            ...
                            <input type="text" class="span2" readonly="true" value="
