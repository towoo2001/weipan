   ...
   <div class="container-fluid">
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    <form action="/Admin/User/act_recommend" method="post" class="new_user_form">
                    ...
                    <div class="span6 with-sidebar">
                        ...
                        <div class="span9 field-box">
                            <label>推广人奖励:</label>
                            <input class="span2" type="text" name="recommend" value="<?php echo ($recommend); ?>" />
                            %
                            （ 直接推广关系 A->B, A 获得的利润）<br>
                           <span style="float:right">建议范围:1% ~ 10%</span> 
                        </div> 
                         <div class="span9 field-box">
                            <label>上级推广人奖励:</label>
                            <input class="span2" type="text" name="recommend2" value="<?php echo ($recommend2); ?>" />
                            %  （ 间接推广关系 A->B->C, A 获得 B 的利润）<br>
                            <span style="float:right">建议范围:30% ~ 70%</span> 
                        </div>
