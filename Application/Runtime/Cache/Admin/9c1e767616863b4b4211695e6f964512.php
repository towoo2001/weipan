...
<body>
    ...
    <div class="container-fluid">
    	<div id="pad-wrapper" class="users-list">
            ...
            <!---type list---->
			<ul class="ce">
				<?php if(is_array($typelist)): $i = 0; $__LIST__ = $typelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tl): $mod = ($i % 2 );++$i;?><li class="mulu_list">
					<span class="open"><img class="more" src="/Public/Admin/img/dedeexplode.gif"/></span>
					<div class="muleft">
						<input type="checkbox" name=""><a class="xz" href="#"><?php echo ($tl['cname']); ?></a>
					</div>
				    <div class="muright"><a href="">更改</a>|<a href="">删除</a></div>
				    <div class="clear"></div>
