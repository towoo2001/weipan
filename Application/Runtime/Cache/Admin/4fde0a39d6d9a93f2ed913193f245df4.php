        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span8 column">
					...
					<div class="field-box">
						<label>优惠卷价格：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入优惠卷类型" data-placement="right" name="eprice"/>
					</div>
					<!--<div class="field-box">
                        <label>分发用户:</label>
					...
					<div class="field-box">
                        <label>开始时间:</label>
                        <input type="text" value="" class="input-large datepicker" name="gettime"/>
                    </div>
					<div class="field-box">
                        <label>结束时间:</label>
