...
<head>
    ...
    <link rel="stylesheet" href="/Public/Admin/css/compiled/personal-info.css" type="text/css" media="screen" />
...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            <a class="brand" href="index.html"><img src="/Public/Admin/img/logo.png" /></a>
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    <li class="active"><a href="<?php echo U('Admin/Index/index');?>">系统首页</a></li>
                    <li><a href="<?php echo U('News/newslist');?>">文章管理</a></li>
                    <li><a href="<?php echo U('Goods/glist');?>">产品管理</a></li>
                    <li><a href="<?php echo U('User/ulist');?>">客户管理</a></li>
                    <li><a href="<?php echo U('Order/olist');?>">订单管理</a></li>
                    <li><a href="<?php echo U('Coupons/cplist',array('style'=>'list'));?>">优惠劵管理</a></li>
                    <li><a href="<?php echo U('Super/slist');?>">系统管理员</a></li>
                </ul>
            </div>
            ...
            <div class="settings-wrapper" id="pad-wrapper">
                ...
                <div class="span3 avatar-box">
                    <div class="personal-image">
                        <img src="/Public/Admin/img/personal-info.png" class="avatar img-circle" />
                        <p>上传个人照片...</p>
                ...
                <div class="span7 personal-info">
                    <div class="alert alert-info">
                        ...
                        超级管理员信息，建议不要随意修改。
                        <br /> 密码不要过于简单 <strong></strong> 
                    </div>
                    <h5 class="personal-title">管理员信息</h5>
