   ...
   <div class="container-fluid">
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    <form action="<?php echo U(Menber/mupdate);?>" method="post" class="new_user_form" onsubmit="return subform();">
                    <!-- left column -->
                    <div class="span6 with-sidebar">
                    	<input class="span4" type="hidden" name="otype" value="<?php echo ($us["otype"]); ?>"/>
                    	<input class="span4" type="hidden" name="uid" value="<?php echo ($us["uid"]); ?>"/>
                    	<input class="span4" type="hidden" name="utime" value="<?php echo ($us["utime"]); ?>"/>
                        <div class="span9 field-box uname">
                            <label>姓名:</label>
                            <input class="span4" type="text" name="username" value="<?php echo ($us["username"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入会员姓名" data-placement="right" readonly="true"/>
                        </div>
                        <div class="span9 field-box">
                            <label>电话:</label>
                            <input class="span3" type="text" name="utel" value="<?php echo ($us["utel"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入会员电话" data-placement="right" />
                        </div>
                        <div class="span9 field-box">
                            <label>办公地址:</label>
                            <input class="span8" type="text" name="address" value="<?php echo ($us["address"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入办公地址" data-placement="right" />
                        </div>
                        <div class="span9 field-box">
                            <label>身份证号码:</label>
                            <input class="span8" type="text" name="brokerid" value="<?php echo ($mg["brokerid"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入身份证号码" data-placement="right" />
                        </div>
                        <div class="span9 field-box">
                            <label>公司名称:</label>
                            <input class="span8" type="text" name="comname" value="<?php echo ($us["comname"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入公司名称" data-placement="right" />
                        </div>
                        <div class="span9 field-box">
                            <label>公司资质:</label>
                            <input class="span8" type="text" name="comqua" value="<?php echo ($us["comqua"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入公司资质号码" data-placement="right" />
                        </div>
                        <div class="span9 field-box">
                            <label>返点:</label>
                            <input class="span1" type="text" name="rebate" value="<?php echo ($us["rebate"]); ?>" data-toggle="tooltip" data-trigger="focus" title="请输入交易返点" data-placement="right" />%&nbsp;&nbsp;注：单这条会员的交易的盈亏
                        </div>
                        <div class="span3 field-box">
                            <label>手续费返点:</label>
                            <input class="span1" type="text" value="<?php echo ($us["feerebate"]); ?>" name="feerebate" data-toggle="tooltip" data-trigger="focus" title="请输入交易费用返点" data-placement="right" />%&nbsp;&nbsp;注：单笔手续费用交易的返点
                        </div>
						<div class="span3 field-box">
                            <label>隔夜利息返点:</label>
                            <input class="span1" type="text" value="<?php echo ($us["gefeebate"]); ?>" name="gefeebate" data-toggle="tooltip" data-trigger="focus" title="请输入交易费用返点" data-placement="right" />%&nbsp;&nbsp;注：隔夜利息的返点
                        </div>
                        <div class="span3 field-box">
                            <label>新密码:</label>
