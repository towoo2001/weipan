    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            <div class="row-fluid form-wrapper">
                <!-- left column -->
                <form action="<?php echo U('News/newsadd');?>" enctype="multipart/form-data" method="post" id='fr'>
                <div class="span8 column">
					<div class="field-box">
						<label>文章标题：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入文章标题" data-placement="right" name="ntitle"/>
					</div>
					<div class="field-box">
						<label>文章栏目:</label>
						<div class="ui-select span5">
							<select style="width: 100%;" name="ncategory">
									<?php if(is_array($nclist)): $i = 0; $__LIST__ = $nclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nl): $mod = ($i % 2 );++$i;?><option value="<?php echo ($nl['fid']); ?>" selected=""><?php echo ($nl['fclass']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
					<div class="field-box">
						<label>缩略图:</label>
						<input class="span6 inline-input" type="text" name="ncover" value="" />
					...
					<div class="field-box">
                        <label>更新时间:</label>
                        <input type="text" value="" class="input-large datepicker" name="ntime"/>
                    </div>
					<div class="field-box">
						<label>文章内容:</label>
                    ...
                    <div class="field-box actions" style="text-align:left;">
						<input  id='sbtn' type="submit" class="btn-glow primary" value="提交">
						<span style="padding:0 10px;"></span><input type="reset" value="重置" class="btn-glow primary">
					</div>
                </div>
				</form>
            </div>
