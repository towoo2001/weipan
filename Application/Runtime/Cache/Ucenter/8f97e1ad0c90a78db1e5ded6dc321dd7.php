				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>充值提现</strong>
								<div style="display: inline-block; margin-left: 20px">
								 <form id="tradefrom"  method="get" action="<?php echo U('Trade/recharge');?>">
									...
									<select id="type" class="span6" name="type">
								...
								<span>下级单位</span>
									<select style="width:100px;background:nono" name="oid">
										<option></option>
									...
									<span>名字：</span><input style="width:12%;border:10px" type="text" value="<?php echo ($sea["username"]); ?>" name="username">
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  <thead>
								  <tr>
									  <th>编号</th> <th>用户</th><th>上级</th><th>操作时间</th> <th>交易类型</th> <th>金额</th>
								  </tr>
							  </thead>   
							  <tbody>
							  <?php if(is_array($rechargelist)): foreach($rechargelist as $key=>$vo): ?><tr> 
										<td><?php echo ($vo["bpid"]); ?></td>
		                                <td><?php echo ($vo["username"]); ?></td>
										<td><?php echo ($vo["oid"]); ?></td>
										<td><?php echo ($vo["bptime"]); ?></td>
										<td><?php echo ($vo["bptype"]); ?></td>
										<td><?php echo ($vo["bpprice"]); ?></td>
							...
							<span style="margin-right:30px;float:right">总金额：<i style="color:red"><?php echo ($summoeny); ?>元</i></span>
