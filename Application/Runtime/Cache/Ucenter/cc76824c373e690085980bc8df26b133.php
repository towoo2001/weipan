			    ...
			    <div class="col-md-6">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong><?php if($user["uid"] != ''): ?>修改会员信息<?php else: ?>添加会员<?php endif; ?></strong></h2>
			            </div>
							<form action="<?php echo U('Customer/customeradd');?>" method="post" enctype="multipart/form-data" class="form-horizontal ">
							<div class="panel-body">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" value="<?php echo ($user["brokerid"]); ?>" name="brokerid" class="form-control">
				                    </div>
				                </div>
				                <?php if($user["uid"] == ''): ?><div class="form-group">
				                    <label class="col-md-3 control-label" for="password-input">初始密码</label>
				                    <div class="col-md-9">
				                        <input type="text"  value="默认和用户名一样"  disabled="disabled" class="form-control">
				                    </div>
				                </div><?php endif; ?>
							</div>
