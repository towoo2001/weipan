$(document).ready(function() {
    ...
    $('.pbaiyin div').click(function() {
        $(this).parent().find('div').removeClass('proqie');
        $(this).addClass('proqie');
    });
    $('.ptong div').click(function() {
        $(this).parent().find('div').removeClass('proqie');
        $(this).addClass('proqie');
    });
    $('.pliqing div').click(function() {
        $(this).parent().find('div').removeClass('proqie');
        $(this).addClass('proqie');
    });
    $(".back").click(function() {
...
function abc(code) {
    ...
    get_url = function(is_iframe) {
        ...
        if (code == "CAD-LME") {
            var rate = $("#rate1").val();
        } else if (code == "XAGUSDOZ SC-FX") {
            var rate = $("#rate2").val();
        }else if (code == "CL I6-NX") {
            var rate = $("#rate3").val();
        }
...
function butt1() {
    var rate = $("#rate1").val();
    var yprice = $('#baiyinjia').html();
    var alldata_url = "http://wei.yytxzb.com/Home/Detailed/getnowdata";
    var code = "CAD-LME";
...
function butt2() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (put > yprice) {
                $('#liqing').attr("class", "rise");
                $("#six").hide();
                $("#five").show();
            } else if (put == yprice) {} else {
                $('#liqing').attr("class", "drop");
                $("#five").hide();
                $("#six").show();
            }
...
function butt3() {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $('.ycliqing').html(put);
            if (put > yprice) {
                $('#tongjia').attr("class", "rise");
                $("#four").hide();
                $("#three").show();
            } else if (put == yprice) {} else {
                $('#tongjia').attr("class", "drop");
                $("#three").hide();
                $("#four").show();
            }
